        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-white font-semibold text-xl font-playfair">+92 300 0000000</p>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-green-950 font-semibold text-lg font-playfair">info@muslimacademia.com</p>
