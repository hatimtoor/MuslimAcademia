          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>123 Education Street, Model Town,<br />Lahore, Pakistan</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/923257496934" className="hover:text-gold-500 transition-colors duration-200">
                  +92 325 7496934
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:Hassan.muhaiyuldin@gmail.com" className="hover:text-gold-500 transition-colors duration-200">
