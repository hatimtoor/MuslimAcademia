          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/923000000000" className="hover:text-gold-500 transition-colors duration-200">
                  +92 300 0000000
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@muslimacademia.com" className="hover:text-gold-500 transition-colors duration-200">
